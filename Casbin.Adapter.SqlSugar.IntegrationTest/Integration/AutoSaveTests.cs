...
// {
//     /* ORIGINAL EFCORE CODE - Preserved for reference
//     /// <summary>
...
namespace Casbin.Adapter.SqlSugar.UnitTest.Integration
{
    ...
    // public class AutoSaveTests : IAsyncLifetime
    // {
    ...
    public class AutoSaveTests : TestUtil, IAsyncLifetime
    {
        ...
        /// </summary>
        /* ORIGINAL EFCORE CODE - ThreeWayContextProvider
        ...
        */
        ...
        // SQLSUGAR VERSION - Replaces EFCore InitPolicyAsync
        // private static async Task InitPolicyAsync(ISqlSugarClient client)
        // {
        ...
        //         new CasbinRule { PType = "p", V0 = "data2_admin", V1 = "data2", V2 = "read" },
        //         new CasbinRule { PType = "p", V0 = "data2_admin", V1 = "data2", V2 = "write" },
        //         new CasbinRule { PType = "g", V0 = "alice", V1 = "data2_admin" }
        //     };

        //     await client.Insertable(policies).ExecuteCommandAsync();
        // }
